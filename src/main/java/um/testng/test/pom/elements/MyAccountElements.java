...
public class MyAccountElements {
	...
	public static By clickFavoriteCheckbox() {
		return WrapperMethods.locatorValue(Locators.XPATH, "//label[@class='ellipsis-text']//input[1]");
	}

	public static By favoriteRoomName() {
		return WrapperMethods.locatorValue(Locators.XPATH, "(//div[contains(@class,'col-sm-3 col-xs-5')]//a)[1]");

	}

	public static By createReservationFavoriteRoom() {
		return WrapperMethods.locatorValue(Locators.XPATH, "(//table[@role='grid']//a)[2]");
	}
	public static By createReservationNoFavoriteRoom() {
		return WrapperMethods.locatorValue(Locators.XPATH, "//div[text()='No space available']");
	}
