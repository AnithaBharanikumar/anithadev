...
public class HomeSearchLocation {
	public static void verifySearchLocation() throws IOException {
		try
		{
			...
			HomePageFunc.validateSearchLocationResult(TestDataProvider.getData("Searchtext"));
		}
		catch(Exception e)
		{
