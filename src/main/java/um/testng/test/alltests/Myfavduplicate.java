...
public class Myfavduplicate {
	public static void verifyFavduplicate() throws IOException {
		try
		{	
		    ...
		    MyAccountFunc.getduplicateFavroom(TestDataProvider.getData("favrooms"));
		    MyAccountFunc.getduplicateFavroomMessage();
